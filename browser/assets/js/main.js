// bain-et-cuisine/src/assets/js/main.js
/**
...
// All of the original template's code is now wrapped in this function.
// Angular will call this function AFTER the page has been rendered.
function initMainScript() {
  ...
  // Call the function to make sure everything inside it runs
  aosInit();
  initSwiper();
  ecommerceCartTools();
  productDetailFeatures();
